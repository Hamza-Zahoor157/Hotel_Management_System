...
namespace Identity_Example.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Adding claim here...
                    //Claim c = new Claim("Role",Input.RoleType);
                    await _userManager.AddClaimAsync(user, new Claim("Role", Input.RoleType));
